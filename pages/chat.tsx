...
import styles from '../styles/AdminChat.module.css'; // Import our new CSS module
  ...
  return (
    <div className={styles.chatContainer}>
      ...
      <div className={styles.chatWindow}>
        {selectedUser ? (
          <>
            <div className={styles.chatHeader}><h3>Chat with {selectedUser.username}</h3></div>
            <div className={styles.messageArea}>
              {messages.map(msg => (
                <div key={msg.id} className={`${styles.messageWrapper} ${msg.sent_by_admin ? styles.adminMessage : styles.userMessage}`}>
                  <div className={`${styles.chatBubble} ${msg.sent_by_admin ? styles.adminBubble : styles.userBubble}`}>
                    {msg.content}
                  </div>
